// 1️⃣ Import React and testing utilities
import React from "react";
import { render, screen } from "@testing-library/react";
import userEvent from "@testing-library/user-event";

// 2️⃣ Import jest-dom for extended matchers like toBeChecked() and toBeInTheDocument()
import "@testing-library/jest-dom";

// 3️⃣ Import the component to test
import App from "../App";
